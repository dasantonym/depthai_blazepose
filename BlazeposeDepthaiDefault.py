...
class BlazeposeDepthaiDefault:
    ...
    def __init__(self, input_src="rgb",
        ...
        self.pd_model = 'models/pose_detection_sh6.blob'
        print(f"Pose detection blob file : {self.pd_model}")
        self.rect_transf_scale = 1.25
        self.lm_model = str(SCRIPT_DIR / "models/pose_landmark_lite_sh6.blob")
